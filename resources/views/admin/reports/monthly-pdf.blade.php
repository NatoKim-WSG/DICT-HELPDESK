...
<head>
                    ...
                    <table class="report-table">
                        ...
                        <tbody>
                            @foreach([
                                ...
                                ['label' => 'Resolved / Closed', 'count' => $resolvedOrClosedStatusCount],
                            ] as $statusRow)
                                <tr>
    ...
    <div class="footnote">
        <div><strong>Notes:</strong> "Completed" and "Resolved / Closed" include tickets created in the reporting month that are now resolved or closed.</div>
