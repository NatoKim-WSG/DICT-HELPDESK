<?php $__env->startSection('title', 'Edit User - iOne Resources Ticketing'); ?>
                    ...
                    <div class="sm:col-span-1">
                        ...
                        <div class="mt-1">
                            <select name="role" id="role" required
                                class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md <?php $__errorArgs = ['role'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\iOne5\Desktop\app\Ticketing\ione-ticketing-system\resources\views/admin/users/edit.blade.php ENDPATH**/ ?>