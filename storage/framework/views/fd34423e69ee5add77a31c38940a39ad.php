    ...
    <div class="bg-white shadow-sm">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div class="flex items-center">
                <img src="<?php echo e(asset('images/dar-logo.png')); ?>" alt="DAR Logo" class="h-10 w-auto mr-3">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input id="department" name="department" type="text"
                           class="form-input <?php $__errorArgs = ['department'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="text-center">
                <p class="text-sm text-gray-600">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="font-medium text-ione-blue-600 hover:text-ione-blue-500">
                        Sign in here
                    </a>
                </p>
            </div>
...
</html><?php /**PATH C:\Users\iOne5\Desktop\app\Ticketing\DAR\ione-ticketing-system\resources\views/auth/register.blade.php ENDPATH**/ ?>